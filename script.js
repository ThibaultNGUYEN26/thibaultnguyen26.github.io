...
function activateCountdown(element, dateString) {
    ...
    element.querySelector(".until__event").textContent = `Until ${ targetDate.format("D MMMM YYYY H:mm:ss") }`;
...
activateCountdown(document.getElementById("myCountDown"), "2024-08-25 17:00:00")